...
class Chat(models.Model):
    ...
    user1 = models.ForeignKey(Accounts, null=False, related_name='user1',
                              on_delete=models.CASCADE)
    user2 = models.ForeignKey(Accounts, null=False, related_name='user2',
                              on_delete=models.CASCADE)
...
class ChatMessage(models.Model):
    ...
    sender = models.ForeignKey(Accounts, null=False, related_name='sender',
                               on_delete=models.CASCADE)
